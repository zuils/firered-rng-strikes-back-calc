...
function calculateADV(gen, attacker, defender, move, field) {
    ...
    desc.HPIVs = "".concat(defender.ivs.hp, " IV");
    ...
    desc.attackIVs = (0, util_1.getIVDescriptionText)(gen, attacker, attackStat);
    desc.attackEVs = (0, util_1.getEVDescriptionText)(gen, attacker, attackStat, attacker.nature);
    var defenseStat = isPhysical ? 'def' : 'spd';
    var defenseIVs = (0, util_1.getIVDescriptionText)(gen, defender, defenseStat);
